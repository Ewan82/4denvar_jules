...
ancillaries_nml.mapping["jules_soil_props_1_const_val"]=" 6.6313, 0.3967309, 0.0027729999, 0.45809999, 0.3283205, 0.1866, 1185786.0, 0.2269195, 0.155,"
...
ancillaries_nml.mapping["jules_frac_1_file"]=" 'data/tile_fractions_evergreen.dat',"
...
ancillaries_nml.mapping["jules_crop_props_1_const_val"]="  510.11138916 501.136169434 110,"
...
drive_txt="""
&jules_drive
diff_frac_const= ${jules_drive_1_diff_frac_const},
...
drive_nml.mapping["jules_drive_1_data_start"]="  '2002-01-01 00:00:00',"
drive_nml.mapping["jules_drive_1_file"]="  'metolius_met.dat',"
drive_nml.mapping["jules_drive_1_diff_frac_const"]=" 0.1,"
drive_nml.mapping["jules_drive_1_var"]=" 'sw_down' 'lw_down' 'precip' 't' 'wind' 'pstar' 'q',"
drive_nml.mapping["jules_drive_1_nvars"]="  7,"
...
drive_nml.mapping["jules_drive_1_data_period"]="  1800,"
drive_nml.mapping["jules_drive_1_interp"]=" 'nf' 'nf' 'nf' 'nf' 'nf' 'nf' 'nf' 'nf',"
...
initial_conditions_nml.mapping["jules_initial_1_var"]="'canopy','tstar_tile','cs','gs','rgrain','cropdvi','croprootc','cropharvc','cropreservec','croplai','cropcanht','lai','sthuf','t_soil','snow_tile',"
initial_conditions_nml.mapping["jules_initial_1_nvars"]="15,"
initial_conditions_nml.mapping["jules_initial_1_const_val"]="0.0,276.78,12.1,0.0,50.0,-2.0,0.0001,0.0,0.0,0.001,0.001,0.55,275.0,0.0,4.0,"
initial_conditions_nml.mapping["jules_initial_1_dump_file"]=".false.,"
initial_conditions_nml.mapping["jules_initial_1_use_file"]="15*.false.,"
...
phenol_period= ${jules_vegetation_1_phenol_period},
...
jules_vegetation_nml.mapping["jules_vegetation_1_phenol_period"]=" 1,"
...
&jules_latlon
latitude= ${jules_latlon_1_latitude},
longitude= ${jules_latlon_1_longitude},
/
...
model_grid_nml.mapping["jules_latlon_1_longitude"]="  -121.5574,"
model_grid_nml.mapping["jules_latlon_1_latitude"]="  44.4523,"
model_grid_nml.mapping["jules_surf_hgt_1_zero_height"]=" .true.,"
model_grid_nml.mapping["jules_input_grid_1_nx"]=" 1,"
model_grid_nml.mapping["jules_input_grid_1_ny"]=" 1,"
...
timesteps_nml.mapping["jules_spinup_1_spinup_start"]="  '2004-01-01 00:00:00',"
timesteps_nml.mapping["jules_spinup_1_use_percent"]="  T F,"
timesteps_nml.mapping["jules_time_1_main_run_start"]="  '2010-01-01 00:00:00',"
timesteps_nml.mapping["jules_spinup_1_max_spinup_cycles"]="  2,"
timesteps_nml.mapping["jules_time_1_main_run_end"]="  '2010-12-31 23:30:00',"
timesteps_nml.mapping["jules_spinup_1_nvars"]="  2 ,"
timesteps_nml.mapping["jules_spinup_1_terminate_on_spinup_fail"]="  F,"
timesteps_nml.mapping["jules_spinup_1_spinup_end"]="  '2004-12-31 21:00:00',"
...
output_nml.mapping["jules_output_profile_1_nvars"]=" 10,"
output_nml.mapping["jules_output_profile_1_profile_name"]=" 'daily',"
...
output_nml.mapping["jules_output_profile_1_var"]=" 'rainfall', 'precip', 'smcl', 't_soil', 'tstar', 'fsmc', 'npp', 'gpp', 'lai', 'latent_heat',"
output_nml.mapping["jules_output_profile_1_file_period"]=" 0,"
output_nml.mapping["jules_output_1_run_id"]=" 'xa',"
output_nml.mapping["jules_output_profile_1_var_name"]=" 'rainfall', 'precip', 'smcl', 't_soil', 'tstar', 'fsmc', 'npp', 'gpp', 'lai', 'latent_heat',"
output_nml.mapping["jules_output_profile_1_output_period"]=" 86400,"
output_nml.mapping["jules_output_profile_1_output_type"]=" 10*'M',"
...
pft_params_nml.mapping["jules_pftparm_1_gpp_st_io"]=" 1.29e-7,2.58e-8,2.07e-7,3.42e-7,1.68e-7,2.07e-7,2.07e-7,3.42e-7,2.07e-7,"
pft_params_nml.mapping["jules_pftparm_1_dgl_dt_io"]=" 9*9,"
pft_params_nml.mapping["jules_pftparm_1_albsnf_max_io"]=" 0.1,0.1,7*0.2,"
pft_params_nml.mapping["jules_pftparm_1_tleaf_of_io"]=" 278.15,233.15,278.15,278.15,233.15,200.15,278.15,278.15,278.15,"
...
pft_params_nml.mapping["jules_pftparm_1_neff_io"]=" 8.00e-4,8.00e-4,8.00e-4,4.00e-4,8.00e-4,0.000579264152199, 8.00e-4,4.00e-4,8.00e-4,"
